Create Table if not exists FinalTransfersDataset(
		Team varchar(30),
        League varchar(30),
        Season int,
        Spend varchar(30),
...
DELIMITER $$
CREATE PROCEDURE createFinalCleanedTable()
BEGIN
    ...
    INSERT INTO FinalTransfersDataset
    SELECT 
		team,
        league,
        season,
...
call createFinalCleanedTable();


SELECT DISTINCT Team , Count(Team) FROM FinalTransfersDataset GROUP BY Team;
